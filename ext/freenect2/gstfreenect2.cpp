 ...
 *
 * gstfreenect2.c: plugin registration
 *
 ...
 * More concretely on the "libfreenect2-dev" and "libfreenect2" packages - that can
...
{
  if (!gst_freenect2src_plugin_init (plugin))
    return FALSE;
